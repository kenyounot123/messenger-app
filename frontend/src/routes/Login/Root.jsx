  ...
  return (
    <div className="flex justify-center items-center h-screen w-screen bg-gradient-to-b from-gradient-black to-gradient-grey">
      <div className="flex flex-col gap-16">
        ...
        <div className="flex flex-col border-2 border-accent-color justify-center items-center bg-gradient-to-b from-gradient-box-grey to-gradient-box-white self-center w-full bg-black rounded-xl min-h-96">
          {formAuth === "login" ? (
